...
-(void)internalInit:(DWSipStack*)_sipStack andHandle: (tsip_ssession_handle_t*)_handle{
	...
	// SigComp
	[self setSigCompId:[sipStack sigCompId]];
...
-(DWRegistrationSession*)initWithStack:(DWSipStack *)_sipStack{
	if((self = (DWRegistrationSession*)[super initWithType:SESSION_TYPE_REGISTRATION andStack:_sipStack])){
		...
		[self addCaps:@"+g.3gpp.smsip"];
		
		/* support for OMA Large message (as per OMA SIMPLE IM v1) */
		[self addCaps:@"+g.oma.sip-im.large-message"];
		...
		[self addCaps:@"audio"];
		[self addCapsWithName:@"+g.3gpp.icsi-ref" andValue:@"\"urn%3Aurn-7%3A3gpp-service.ims.icsi.mmtel\""];
		[self addCapsWithName:@"+g.3gpp.icsi-ref" andValue:@"\"urn%3Aurn-7%3A3gpp-application.ims.iari.gsma-vs\""];
