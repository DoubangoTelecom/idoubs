...
- (IBAction) onButtonClick: (id)sender{
	if(sender == buttonSend){
		...
		[CallViewController makeAudioCallWithRemoteParty:self.remotePartyUri andSipStack:[[NgnEngine sharedInstance].sipService getSipStack]];
	}
	else if(sender == buttonVideoCall){
		[CallViewController makeAudioVideoCallWithRemoteParty:self.remotePartyUri andSipStack:[[NgnEngine sharedInstance].sipService getSipStack]];
	}
